...
namespace Com.Salesforce.Marketingcloud.Location {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.salesforce.marketingcloud.location']/class[@name='LocationReceiver']"
	[global::Android.Runtime.Register ("com/salesforce/marketingcloud/location/LocationReceiver", DoNotGenerateAcw=true)]
	public partial class LocationReceiver : global::Android.Content.BroadcastReceiver {

		internal static new IntPtr java_class_handle;
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/salesforce/marketingcloud/location/LocationReceiver", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (LocationReceiver); }
		}

		protected LocationReceiver (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.salesforce.marketingcloud.location']/class[@name='LocationReceiver']/constructor[@name='LocationReceiver' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe LocationReceiver ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (((object) this).GetType () != typeof (LocationReceiver)) {
					SetHandle (
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.salesforce.marketingcloud.location']/class[@name='LocationReceiver']/method[@name='onReceive' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='android.content.Intent']]"
